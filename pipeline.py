...
LUA_SHA1 = get_hash(os.path.join(CWD, 'tistory.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--header', 'Referer: https://tistory.com/'
        ]
        ...
        get_site = lambda s: (s+'.tistory.com') if '.' not in s else s
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'blog':
                ...
                wget_args.extend(['--warc-header', 'tistory-article-{}: {}'.format(site, path)])
                wget_args.append('https://{}/{}'.format(site, path))
            elif item_type == 'asset':
                url = 'https://' + item_value
                wget_args.extend(['--warc-header', 'tistory-asset: '+url])
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/1/1d/Tistory-icon.png" height="50px" title=""/>
        <h2>Tistory <span class="links"><a href="https://www.tistory.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/tistory/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Tistory">Wiki</a></span></h2>
        <p>Archiving Tistory.</p>
    '''
)
